...
# GENERAL settings
##############################
BASE_FOLDER = 'C:/Users/Jake King/python projects/Mouse-Dynamics-Challenge-master/'
TRAINING_FOLDER = 'training_files'
TEST_FOLDER   = 'test_files'
PUBLIC_LABELS = 'public_labels.csv'
TRAINING_FEATURE_FILENAME  = 'balabit_features_training.csv'
TEST_FEATURE_FILENAME  = 'balabit_features_test.csv'
...
ACTION_CSV_HEADER = "type_of_action,traveled_distance_pixel,elapsed_time,direction_of_movement,straightness,num_points,sum_of_angles,mean_curv,sd_curv,max_curv,min_curv," \
                    ...
                    "\n"
ACTION_FILENAME = 'balabit_actions.csv'
